...
class BootstrapCustomTableForTwentyRow extends Component {
    ...
    const options = {
        ...
        sizePerPage: (this.props.hasOwnProperty('total') ? this.props.total : 20),  // which size per page you want to locate as default
      ...
      return (
        <Fragment>
        <BootstrapTable ref={(this.props.ref) ? this.props.ref : ''} data={ (this.props.table_body) ? this.props.table_body : [] } cellEdit={cellEditProp} selectRow={this.props.select ? selectRowProp: false} pagination   options={ options } responsive striped   hover search={(this.props.search) ? true : false}>
  ...
  export default BootstrapCustomTableForTwentyRow;