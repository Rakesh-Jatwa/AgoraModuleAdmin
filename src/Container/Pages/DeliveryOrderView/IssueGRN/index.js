...
class IssueGRN extends Component {
    ...
    closemodel = () => {
        ...
        if(this.state.status && this.state.submit_type=="Submit"){
            this.props.history.push({ pathname : '/deliveryorder'})
    ...
    componentDidUpdate(){
       ...
       if(this.props.get_issue_grn && this.props.get_issue_grn.poDetailsList  && this.props.get_issue_grn.poDetailsList.PO_DETAILS && this.state.render_table_input==false){
            ...
            if(_temp_details.length){
                ...
                console.log('_ship_qty', enumObject.DOD_SHIPPED_QTY, _ship_qty)
                   _temp_array[index] = {
                ...
                if(_temp_array.length){
                    this.setState({
                        ...
                        table_input_inital:_temp_array,
    ...
    async HandleSave(details,action){
        ...
        if(otherDetails.DOM_UI_S_REF_DATE){
            ...
            for (let index = 0; index < PO_DETAILS.length; index++) {
                ...
                if(this.checkQty(PO_DETAILS)){                
                    ...
                    else if( temp.DOD_SHIPPED_QTY!=0 && (temp.DOD_SHIPPED_QTY != (element.POD_ORDERED_QTY - element.POD_DELIVERED_QTY - element.POD_CANCELLED_QTY)) && action=="Submit" && (!temp.DOD_REMARKS)){
    ...
    ClearAll = () =>{
        let {table_inputs} = this.state;
        let _updated_input = new Array();
        if(this.props.get_issue_grn && this.props.get_issue_grn.poDetailsList  && this.props.get_issue_grn.poDetailsList.PO_DETAILS){
            let _temp_details = this.props.get_issue_grn.poDetailsList.PO_DETAILS;
            if(_temp_details.length){
                _temp_details.forEach((enumObject, index)=>{
        ...
        if(table_inputs && table_inputs.length){
            table_inputs.forEach((list, index)=>{
                table_inputs[index] = _updated_input[index]
    ...
    render(){
         ...
         const _table_header = [
            ...
            {name : "EDD (Date)", id:"POM_CREATED_DATE", width:'104px', formatter: (cellContent, row) => {
                if(this.props.get_issue_grn  && this.props.get_issue_grn.poDetailsList && this.props.get_issue_grn.poDetailsList.POMSTR  &&this.props.get_issue_grn.poDetailsList.POMSTR.length){
                    return addDate(this.props.get_issue_grn.poDetailsList.POMSTR[0].POM_CREATED_DATE, row.POD_ETD, 'days')
                }
        ...
        return <Fragment>
                ...
                <div className="row">
                    ...
                    <div className="col"><p>{(this.props.get_issue_grn && this.props.get_issue_grn.poDetailsList && this.props.get_issue_grn.poDetailsList.DO_MSTR && this.props.get_issue_grn.poDetailsList.DO_MSTR.length) ? <Fragment>{this.props.get_issue_grn.poDetailsList.DO_MSTR[0].DOM_DO_NO } <sapn className="ml-2 text-danger">{'(Open)'}</sapn></Fragment> :' To be Allocated by the system ' }</p></div>
                ...
                <div className="row mt-2">    
                    <div className='col-12'>   
                        <BootstrapCustomTable 
                            ...
                            table_body={(this.props.get_issue_grn && this.props.get_issue_grn.poDetailsList  && this.props.get_issue_grn.poDetailsList.PO_DETAILS) ? this.props.get_issue_grn.poDetailsList.PO_DETAILS : [] } 
                            select={false} 
                            change={true}
                    ...
                    <div className="col-12">
                        <div className="text-right mt-2 row">
                            ...
                            <div className="col-12 col-sm-6">
                                ...
                                {(this.props.get_issue_grn && this.props.get_issue_grn.poDetailsList  && this.props.get_issue_grn.poDetailsList.DO_MSTR && this.props.get_issue_grn.poDetailsList.DO_MSTR.length > 0)? <button type="submit" className="ml-4 btn btn-sm btn-outline-danger" onClick={()=>{this.RemoveDeliveryOrder((this.props.get_issue_grn && this.props.get_issue_grn.poDetailsList && this.props.get_issue_grn.poDetailsList.DO_MSTR && this.props.get_issue_grn.poDetailsList.DO_MSTR.length) ? this.props.get_issue_grn.poDetailsList.DO_MSTR[0].DOM_DO_NO : '','delete')}}>Delete DO</button> : ""}
