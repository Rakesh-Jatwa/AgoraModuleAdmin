...
class CompanyDetailsNew extends Component{
    constructor(props){
        super(props);
    ...
    static getDerivedStateFromProps(props,state){   
        ...
        if((!state.file_upload) &&  props.vendor_map_list && props.vendor_map_list.length){
            return {
                products: props.vendor_map_list,
                rendered : true
            }
        }
         else if( (state.file_upload) && props.upload_document && state.coyLogoBool){
            console.log('props.upload_document ',props.upload_document);
         //   attachment.internal_attachment = nextProps.upload_document.responseList;
           // coyLogo.value="";
            return {
                coyLogoName : props.upload_document.fileName
            }
         } else if( (state.file_upload) && props.upload_document && state.TCBool){
            console.log('props.upload_document ',props.upload_document);
         //   attachment.internal_attachment = nextProps.upload_document.responseList;
            const actualfileNameArr= props.upload_document.displayAttachFile.attachFileList;
            console.log('actualfileNameArr.indexOf(todo => todo.strFile1 == props.upload_document.displayAttachFile.fileName) ',actualfileNameArr.findIndex(todo => todo.strFile1 == props.upload_document.fileName));

            console.log(' props.upload_document.displayAttachFile ',props.upload_document.fileName);
    ...
    handlefromsubmit= async(values={}) =>{
        ...
        if(values){
            ...
            if(parseInt(_temp.LicenseUsers) < parseInt(_temp.ReportUsers)){            
                ...
                _temp.strApp = strApp        
                _temp.BCMStart = (_temp.BCMStart) ? FromateDate_YY_MM_DD(_temp.GSTDateLastStatus):   null
                _temp.BCMEnd = (_temp.BCMEnd) ? FromateDate_YY_MM_DD(_temp.GSTDateLastStatus):   null
                ...
                if(strApp && strApp.length){
                    ...
                    if(_status){
                        ...
                        if(!_status.message){
                            this.DownloadDocumentsForLogo({strFile:this.state.CoyLogo_name,strFile1:this.state.coyLogoName,CDA_DOC_TYPE:'CoyLogo'}) 
                        }
                    }
     ...
     render(){           
        ...
        return <Fragment>
            ...
            <div className="show_list">  
                ...
                <TabHeading color={'bg-info text-white'}>Add company</TabHeading> 
                <form onSubmit={handleSubmit(this.handlefromsubmit.bind(this))}>
                    <div className="row mt-2">    
                        <div className='col-12 col-sm-6 col-md-10'>   
                                ...
                                <div className="col-12 col-md-10">
                                    <div className="form-group">                                      
                                        ...
                                        <div className="col-12 col-md-4"><label for="pwd"> Company Logo:</label></div>
                                            ...
                                            <div className="col-md-1"><button type="button" type="button" className="btn btn-outline-primary btn-sm " value="Upload" data-name={this.state.CoyLogo} onClick={() => this.FileUpload('coyLogo')} id="">Upload</button></div> 
                                            <div className="col-md-2"><button type="button" type="button" className="btn btn-outline-primary btn-sm " onClick={this.showPreviewModal} id="">Preview Image</button></div> 
                                           </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-10">
                                    <div className="form-group">
                                        ...
                                        <div className="col-12 col-md-4"><label for="pwd"> T&C Document Upload:</label></div>
                                            ...
                                            <div className="col-md-1"><button type="button" type="button" className="btn btn-outline-primary btn-sm " value="Upload" data-name={this.state.TC} onClick={() => this.FileUpload('TC')} id="">Upload</button></div> 
                            ...
                            { this.state.vendorType  &&  this.state.vendorType =="VENDOR"?  <div className="row mt-6"> 
...
const CompanyDetailsNewHolder = connect(mapStateToProps, mapDispatchToProps)(CompanyDetailsNew);
export default reduxForm({
    form:'CompanyDetailsHolder',

    validate : ValidateCompanyDetails,
    
})(CompanyDetailsNewHolder);