...
class Request extends Component{
    ...
    static async getDerivedStateFromProps(nextProps, prevState){
        ...
        if((!prevState.rendered) && nextProps.location && nextProps.location.datas){
            ...
            _details_main.table_body = await _details_main.table_body.forEach(async (list_details, index)=>{
                ...
                _details_main.table_body[index].default_dl_address = (list_details.delivaryAddressCode) ?  list_details.delivaryAddressCode : '';
    ...
    async handlefiltersubmit(values, details){
        ...
        if(_save_item){
            ...
            _final_datas.customFieldMstr = this.state.customFieldMstr.map((list_details, index)=>{
                if(list_details.PCM_FIELD_NAME){
                    let _temp_Details = list_details
                    _temp_Details.PCD_FIELD_VALUE = list_details.PCM_FIELD_NAME
    ...
    let _grand_total = parseFloat(_sub_total) + parseFloat(_gst_total) + parseFloat(_shipping_amt)
     const { handleSubmit } = this.props
        const _table_header = [
            ...
            {name : "Gift", id:"GIFT", width:'44px',type:"gift"},
            {name : "Fund Type (L1)", id:"FUNDTYPEDESC", type:"text", width:'148px', dataFormat:'select'},
            {name : "Person Code (L9)", id:"PERSONCODEDESC", type:"text", width:'138px'},
            {name : "Project / ACR (L8) Code ", id:"PROJECTCODEDESC", type:"text", width:'157px'},
            {name : "GL Description (GL CODE)", id:"GLDESCRIPTION",type:"text", key:false, width:'150px'},
                ...
                <div className="row mt-2">    
                    <div className='col-12'>
                        <div className="row mt-2"> 
                            ...
                            <div className="col-12 col-md-6">
                                <div className="row mt-2">
                                    <Field className="form-control textboxstyle" defaultValue={'30 Days'} rem={true} component={FromSelect} label="Payment Terms " name="raisePOForm.PaymentType" disable_input={true}>
                            ...
                            <div className="col-12 col-md-6">
                                <div className="row mt-2">
                                    <Field className="form-control textboxstyle" component={FromSelect} name="raisePOForm.PaymentMethod" label="Payment Method:" disable_input={true} rem={true}>
                            ...
                            <div className="col-12 col-md-6">
                                <div className="row mt-2">
                                    <Field className="form-control textboxstyle" component={FromSelect} name="raisePOForm.ShipmentTerm" label=" Shipment Terms :" disable_input={true} rem={true}>
                                        <option defaultValue=''>--Select--</option>
                            ...
                            <div className="col-12 col-md-6">
                                <div className="row mt-2">
                                    <Field className="form-control textboxstyle" component={FromSelect} name="raisePOForm.ShipmentMode" label=" Shipment Mode :" disable_input={true} rem={true}>
                                        <option defaultValue=''>--Select--</option>
