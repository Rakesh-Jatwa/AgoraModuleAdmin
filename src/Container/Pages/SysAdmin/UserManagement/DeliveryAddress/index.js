                 ...
                 <div className="row mb-4">
                    ...
                    <div className="row mt-2">
                        ...
                        <div className="form-check form-check-inline">
                            ...
                            <input classNmae="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" checked={this.state.addType === "A" ? "checked" : null } value="A" onChange = {this.getRadioValue} />
                            <label className="form-check-label ml-2" for="inlineRadio1">All Delivery Address</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input classNmae="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="S" checked={this.state.addType === "S" ? "checked" : null } onChange = {this.getRadioValue} />
                            <label className="form-check-label ml-2" for="inlineRadio2">Selected Delivery Address</label>
                        </div>
