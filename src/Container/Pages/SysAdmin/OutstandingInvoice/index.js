...
import { GetOutstandingInvoice } from '../../../../Actions/SysAdmin';
...
class Report extends Component {
    ...
    getOutstandingInvoice = () => {
        ...
        this.props.GetOutstandingInvoice(data);
    }
    ...
    render() {
        ...
        return <Fragment>
            ...
            <div className="show_list">
                <PageHeading heading="[B] Outstanding Invoice"
                            ...
                            <div className="row mt-2">
                                <div className="col-12 col-md-12 mt-2 text-right">
                                    <button type="submit" className="btn btn-sm btn-outline-success"
                                        onClick={()=>{this.getOutstandingInvoice()}}
                                    >Submit</button>
                                    <button type="reset" className="btn btn-sm btn-outline-danger ml-2">Clear</button>
                                </div>
                            </div>
                            <div className="row mt-2">
                                <div>
...
const mapDispatchToProps = dispatch => ({
    GetOutstandingInvoice: (values) => dispatch(GetOutstandingInvoice(values)),
})
