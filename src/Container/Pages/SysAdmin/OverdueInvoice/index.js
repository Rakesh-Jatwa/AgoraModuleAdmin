...
import { GetOverdueInvoice } from '../../../../Actions/SysAdmin';
...
class Report extends Component {
    ...
    getOverdueInvoice = () => {
        ...
        this.props.GetOverdueInvoice(data);
    }
    ...
    render() {
        ...
        return <Fragment>
            ...
            <div className="show_list">
                <PageHeading heading="[B] Overdue Invoice"
                        ...
                        <div className="col-12 col-sm-12">
                            ...
                            <div className="row mt-2">
                                <div className="col-12 col-md-12 mt-2 text-right"><button type="submit" className="btn btn-sm btn-outline-success"
                                        onClick={()=>{this.getOverdueInvoice()}}
                                    >Submit</button>
...
const mapDispatchToProps = dispatch => ({
    GetOverdueInvoice: (values) => dispatch(GetOverdueInvoice(values)),
})
