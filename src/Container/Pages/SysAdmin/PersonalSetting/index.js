...
import ConfigureDefaultSetting from './ConfigureDefaultSetting' 
    ...
    render (){
        return <div id="tabs">
            <Tabs defaultActiveKey="Master" transition={false} id="tabs" activeKey={this.state.active_key} onSelect={k => {this.setState({active_key:k}) }}>
                <Tab eventKey="Master" title="Personal Details">
                    <div className="tab-content py-3 px-3 px-sm-0">
                        <Master  {...this.props}/>
                    </div>
                </Tab>
                <Tab eventKey="ConfigureDefaultSetting" title="Configure Default Setting">
                    <div className="tab-content py-3 px-3 px-sm-0">
                        <ConfigureDefaultSetting  {...this.props}/>
                    </div>
                </Tab>
        </Tabs>
      </div>
