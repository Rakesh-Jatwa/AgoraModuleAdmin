    ...
    const [columnsList, setColumnsList] = useState([
        {
            ...
            formatter: (cellContent, row) => {
                return (
                    <Button size="sm" variant="primary"  >{row.PRM_PR_No}</Button>
                )
            }, */ 
        },
        {
            ...
            sort: true,
             formatter: (cellContent, row) => {
                 return (
                    <Button size="sm" variant="info"  >{row.POM_PO_No}</Button>
                )
             }, 
        },
        {
