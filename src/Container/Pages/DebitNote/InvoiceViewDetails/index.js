...
let InvoiceViewDetails = props => {
    ...
    let  _table_data_header = [
        ...
        {name : "SST Tax Code (Purchase)", id:"SSTTaxCode", width:'170px', dataFormat:"number"},
    ...
    return <Fragment> 
            ...
            <div className="mt-2 mb-5 row">
                ...
                <div className="col-lg-auto col-md"><button type="button" className="btn btn-outline-success btn-sm" > Verify Credit Note</button> </div>
                <div className="col-lg-auto col-md"><button type="button" className="btn btn-outline-secondary btn-sm" >Ver</button></div>
