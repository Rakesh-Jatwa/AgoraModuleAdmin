...
class InvoiceViewDetails extends Component {
   ...
   static getDerivedStateFromProps(props, state){
       console.log('props.search_list',props.search_list)
        if((state.rendered) && (props.search_list.length >0 )){
           return {
                ...
                rendered: (props.search_list && props.search_list.prodetails && props.search_list.prodetails.dsprodet)    ? false : true,
        ...
        else if ((!state.rendered) && props.search_list.length==0){
            return {
                item_details :  {},
                prefer_vednor :  {},
                rendered: false ,
   ...
   async  submit_invoice(values_details){
    ...
    render(){
        ...
        return <Fragment>
            ...
            <div className="d-flex bg-info text-white p-1 mt-2 main_bold">Files Attached</div>
            <div className="row">
                <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6"><label>File(s) Attached :</label></div>
                <div><p>No Files Attached </p></div>
            </div>
            <div className="mt-2">
                {/* <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6"><button type="button" className="btn btn-outline-danger btn-sm" onClick={()=>this.props.history.goBack()} >Back</button></div> */}
            </div>
        </div>
