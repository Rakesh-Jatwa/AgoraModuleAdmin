...
class ApprovalRejectList extends Component {
    ...
    render(){
        ...
        const _table_data_header = [
            ...
            {name : "SST Rate", id:"PRD_ORDERED_QTY", width:'100px', formatter: (cellContent, row) => {
                return <div className="text-right">{parseFloat(row.PRD_GST_RATE).toFixed(2) }</div>
            }},
            {name : "SST Amount", id:"PRD_GST", width:'100px',  dataFormat:"price"},
        ...
        return <Fragment>
            ...
            <TabHeading color={'bg-info text-white'}>Purchase Request Header</TabHeading> 
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 col-lg-4"> {(this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR  && this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR.length) ?  this.props.search_result.itemDetails.PR_MSTR[0].PRM_PR_NO : '' }</div>
                    {/* <div className="col-12 col-md-2 col-lg-2"><label>  Purchaser :	</label></div>
                    <div className="col-12 col-md-4 col-lg-4"> {(this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR  && this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR.length) ?  this.props.search_result.itemDetails.PR_MSTR[0].PRM_BUYER_NAME : '' }</div> */}
                     <div className="col-12 col-md-2 col-lg-2"><label>  Status :		</label></div>
                    <div className="col-12 col-md-4 col-lg-4"> {(this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR  && this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR.length) ?  this.props.search_result.itemDetails.PR_MSTR[0].STATUS_DESC : '' }</div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 col-lg-4">{(this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR  && this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR.length) ?  this.props.search_result.itemDetails.PR_MSTR[0].PRM_INTERNAL_REMARK : '' }</div>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 col-lg-4"> {(this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR  && this.props.search_result.itemDetails && this.props.search_result.itemDetails.PR_MSTR.length) ?  this.props.search_result.itemDetails.PR_MSTR[0].PRM_External_Remark : '' }</div>
                    <div className="col-12 col-md-2 col-lg-2"><label> 		</label></div>
                    <div className="col-12 col-md-4 col-lg-4"> </div>
                </div>
                ...
                <div className="row mt-2">    
                    ...
                    <div className="mt-2 mb-5 row">
                       ...
                       {(this.props.location && this.props.location.type && this.props.location.type=="cancel" || this.props.location.type=="listing") ? <div className="col-lg-auto col-md"><button type="button" className="btn btn-outline-primary btn-sm" onClick={()=>this.prpdf()}>View PR PDF</button></div> : '' }
                    </div>
